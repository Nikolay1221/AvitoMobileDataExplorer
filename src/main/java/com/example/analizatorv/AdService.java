...
public class AdService {
    private final CustomLogger logger = new CustomLogger(AdService.class);
    ...
    public List<Ad> searchAdsBySimilarTitle(String searchText, double similarityThreshold, boolean useTitleAsOuterLoop) {
        ...
        return allAds
                .stream()
                .filter(ad -> adScores.get(ad) == finalMaxScore)
                .peek(ad -> logger.logInfo("Title: " + ad.getTitle() + ", Score: " + adScores.get(ad)))
